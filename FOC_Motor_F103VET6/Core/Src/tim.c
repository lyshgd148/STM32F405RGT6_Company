...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  if (htim->Instance == TIM3)
  {
    ...
    encoder_angle_last = encoder_angle;
    float _motor_speed = diff_angle * motor_speed_calc_freq; // 计算电机速度 单位rad/s
    float filter_alpha = 0.1f;
    motor_speed = LFP(_motor_speed, motor_speed, filter_alpha);
  }
}
...
void MX_TIM1_Init(void)
{
  ...
  htim1.Init.Period = 72000000/motor_pwm_freq;
...
void MX_TIM3_Init(void)
{
  ...
  htim3.Init.Period = 1000000/motor_speed_calc_freq;
