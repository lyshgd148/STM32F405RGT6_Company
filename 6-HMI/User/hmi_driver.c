...
/*
 ...
 frame		   Icon ?????
*/
void MySetIcon(uint16 screen_id,uint16 control_id,uint8_t frame)
{
	/*EE B1 23 00 00 00 03 00 FF FC FF FF */
	BEGIN_CMD();
...
/*
	清除文本控件值
*/
void MyClearTextVal(uint16 screen_id,uint16 control_id)
{
	/*EE B1 10 00 00 00 09 FF FC FF FF */
	BEGIN_CMD();
