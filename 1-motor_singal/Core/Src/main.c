...
int32_t positionA[motor_num]={240000,-240000,0,0,0};
int32_t positionB[motor_num]={-200,200,0,0,0};
		...
		switch(current_state[i])
		{
			case POS_H:
				if(motor_statuses[i].go_home_flag==1)
				{
					...
					motorGoPosition(i+1,1000,100,motor_statuses[i].positionA);//电机 POSA
					tick=0;
...
//					if((inputs & (1<<(2*i))) !
					if(inputs[i]== true )
					{
						...
						motorGoPosition(i+1,1000,100,motor_statuses[i].positionB);
				...
				if(tick==5000)
				{
					motorGoPosition(i+1,1000,100,motor_statuses[i].positionA);//电机1: POSA
				}
			break;
...
//	  if(inputs[0]==true){
//		  inputs[0]=false;
//		  motorGoPosition(1,1000,100,positionA[0]);
//		  motorGoPosition(2,1000,100,positionA[1]);
//	  }
//	  if(inputs[1]==true){
//	  		  inputs[1]=false;
//	  		  motorGoPosition(1,1000,100,positionB[0]);
//	  		  motorGoPosition(2,1000,100,positionB[1]);
//	  	  }
//	  if(inputs[2]==true){
//		  inputs[2]=false;
//		  motorStop(1);
